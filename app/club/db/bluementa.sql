...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Máj 15. 08:56
...
CREATE TABLE `clubs` (
  ...
  `club_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_hungarian_ci NOT NULL,
  `club_description` varchar(400) CHARACTER SET utf8 COLLATE utf8_hungarian_ci NOT NULL
...
(2, 'Valaki?k', 'hopp?'),
(3, 'dvsvdsv', ''),
(6, 'Egy ?j Club', 'le?r?ssal');

-- --------------------------------------------------------

--
-- Tábla szerkezet ehhez a táblához `clubs_users_switch`
--

CREATE TABLE `clubs_users_switch` (
  `user_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL,
  `club_id` int(11) NOT NULL
...
--
-- Tábla szerkezet ehhez a táblához `quizzez_clubs_switch`
--

CREATE TABLE `quizzez_clubs_switch` (
  `club_id` int(11) NOT NULL,
  `quiz_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- A tábla indexei `clubs_users_switch`
--
ALTER TABLE `clubs_users_switch`
...
--
-- A tábla indexei `quizzez_clubs_switch`
--
ALTER TABLE `quizzez_clubs_switch`
  ADD KEY `club_id` (`club_id`,`quiz_id`),
  ADD KEY `quizzez_id` (`quiz_id`);
...
--
-- Megkötések a táblához `clubs_users_switch`
--
ALTER TABLE `clubs_users_switch`
  ADD CONSTRAINT `clubs_users_switch_ibfk_1` FOREIGN KEY (`club_id`) REFERENCES `clubs` (`club_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `clubs_users_switch_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;

--
-- Megkötések a táblához `quizzez_clubs_switch`
--
ALTER TABLE `quizzez_clubs_switch`
  ADD CONSTRAINT `quizzez_clubs_switch_ibfk_1` FOREIGN KEY (`quiz_id`) REFERENCES `quizzes` (`quiz_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `quizzez_clubs_switch_ibfk_2` FOREIGN KEY (`club_id`) REFERENCES `clubs` (`club_id`) ON DELETE CASCADE;
COMMIT;
